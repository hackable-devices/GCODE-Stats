...
CSplash::CSplash(LPCTSTR lpszFileName, COLORREF colTrans, HINSTANCE hInstance)
{
    Init();
...
DWORD CSplash::SetBitmap(LPCTSTR lpszFileName)
{
    ...
    //  =======================================================================
    HANDLE    hBitmap       = NULL;
    //hBitmap = LoadImage(0, MAKEINTRESOURCE(IDB_SPLASH), IMAGE_BITMAP, 0, 0, LR_LOADFROMFILE);
	hBitmap = LoadImage(_hInstance, MAKEINTRESOURCE(IDB_SPLASH), IMAGE_BITMAP, 0, 0, LR_DEFAULTSIZE | LR_LOADTRANSPARENT);
    return SetBitmap(static_cast<HBITMAP>(hBitmap));
}
